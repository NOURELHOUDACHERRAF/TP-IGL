...
@Component({
  ...
  imports: [CommonModule, FormsModule, BilanBiologiqueComponent, BilanRadiologiqueComponent, AntecedentComponent],
})
export class ResumerComponent {
  @Output() cancel = new EventEmitter<void>();
  @Output() confirm = new EventEmitter<{ date: string, medecin: string, description: string, diagnostique: string, bilanRadiologiqueData: string, bilanBiologiqueData: string, antecedentData: string}>();
  
  date: string = '';
  medecin: string = '';
  description: string = '';
  diagnostique: string = '';
  bilanRadiologiqueDatta: string = '';
  bilanBiologiqueDatta: string = '';
  antecedentDatta: string = '';
